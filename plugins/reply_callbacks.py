...
قم بلأشتراك، وأرسل /start .
        ...
        return await query.edit_message_text(k, reply_markup=mk([[btn(f'- @{i} .', url=f't.me/{i}')]]))
    rk  = """
• ⌁ لشراء نقاط من بوت خدمات التليكرام
...
- - - - - - - - - - - - - - -
⌁ لتبديل نقاط من بوت خدمات التليكرام بدل المليار ↫⤈
• 4000 نقطه (مليار) = 3000 نقطه في البوت
• 10000 نقطه (مليار) = 12000 نقطه في البوت
•15000 نقطه (مليار) = 18000 نقطه في البوت
•20000 نقطه (مليار) = 26000 نقطه في البوت
• ⋯ • ⋯ • ⋯ • ⋯ • ⋯ •• ⋯ • ⋯ • ⋯ • ⋯ • 
.           ⌁ لتبديل نقاط من بوت خدمات التليكرام بدل دعمكم ↫⤈
• 3000 نقطه (دعمكم) = 4000 نقطه في البوت
• 10000 نقطه (دعمكم) = 13000 نقطه في البوت
•15000 نقطه (دعمكم) = 19000 نقطه في البوت
•20000 نقطه (دعمكم) = 29000 نقطه في البوت
• ⋯ • ⋯ • ⋯ • ⋯ • ⋯ •• ⋯ • ⋯ • ⋯ • ⋯ • 
⌁ للتواصل 
⌁@m_n_2
...
- - - - - - - - - - - - - - -
⌁︙طرق الدفع 
⌁︰كريمي  , بايير  , آسيا , زين كاش ,نقاط دعمكم
